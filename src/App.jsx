...
import Spacecrafts, { spacecraftsLoader, destroySpacecraftAction } from "./pages/Spacecrafts.jsx";
...
import Planets, { planetsLoader, sendSpacecraftAction } from "./pages/Planets.jsx";
...
const router = createBrowserRouter(createRoutesFromElements(
  <Route path="/" element={ <RootLayout /> }>
    ...
    <Route path="spacecrafts" element={ <SpacecraftLayout /> } >
      ...
      <Route path="send" action={ sendSpacecraftAction } />
    </Route>
